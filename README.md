# FTB Project EX (1.7.10 Backport)

A 1.7.10 backport of **Project EX**, an expansion mod for **ProjectE** originally developed by LatvianModder and the FTB Team for Minecraft 1.12.2.

This backport brings high-tier EMC automation, storage, and generation mechanics to Minecraft 1.7.10 modpacks while maintaining full compatibility with ProjectE 1.7.10.
...
- Original 1.12.2 mod by [LatvianModder](https://github.com/LatvianModder) and the FTB Team.
